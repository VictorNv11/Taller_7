...
<section class="form-signin w-50 m-auto" style="border: 1px solid darkgrey; background: darkgrey;">
  ...
  <form action="" method="post" >
    ...
    <div class="form-floating mb-3">
      ...
      <label for="Valor" class="pepe">Valor:</label>
    </div>

    <div class="form-floating mb-3">
      <input type="number" class="form-control" id="category" name="category_id" placeholder="Ingrese la categoria" pattern="{12, 20} "required style="width: 50%; margin-left:25%">
      <label for="category" class="pepe">Categoria:</label>
    </div>
